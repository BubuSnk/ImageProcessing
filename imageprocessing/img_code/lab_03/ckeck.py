...
for i in range(64):
    ...
    convolved_channelB = np.maximum(0,convolved_channelB)
    convolved_channelG = np.maximum(0,convolved_channelG)
    convolved_channelR = np.maximum(0,convolved_channelR)
